...
RSpec.describe PasswordChecker do
  describe "check password" do
     it "checks if it has more than 7 characters" do
      expect(PasswordChecker.new.check_charac("3e4r")).to eq(false)
     end

     it "checks if it has at least 1 letter, 1 symbol, 1 number" do
     expect(PasswordChecker.new.check_let_sym_num("qssssseeedd")). to eq(false)
    end
